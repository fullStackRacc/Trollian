...
class User < ApplicationRecord
  ...
  delegate :auto_play_gif, :default_sensitive, :unfollow_modal, :boost_modal, :delete_modal,:emoji_size_simple,
           :emoji_size_detailed, :emoji_size_name, :bbcode_spin, :bbcode_pulse, :bbcode_b, :bbcode_i, :bbcode_color, :bbcode_strike, :bbcode_large, :bbcode_size, :bbcode_u, :bbcode_flip, :bbcode_colorhex, :bbcode_quote, :bbcode_code, :bbcode_center, :bbcode_right, :bbcode_url, :bbcode_caps, :bbcode_lower, :bbcode_kan,
           :bbcode_comic, :bbcode_doc, :bbcode_hs, :bbcode_cute2, :bbcode_oa, :bbcode_sc, :bbcode_impact, :bbcode_luci, :bbcode_pap, :bbcode_copap, :bbcode_na, :bbcode_nac, :bbcode_cute,
